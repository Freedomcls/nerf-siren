...
class TriPlaneGenerator(torch.nn.Module):
    ...
    # def synthesis2(self, ws, ray_origins, ray_directions, semantic_map, neural_rendering_resolution=None, update_emas=False, cache_backbone=False, use_cached_backbone=False, **synthesis_kwargs):
        ...
        rgb_coarse, depth_coarse, weights_coarse, rgb_final, depth_final, weights_final = self.renderer(planes, self.decoder, ray_origins, ray_directions, self.rendering_kwargs) # channels last
        return {'rgb_coarse':rgb_coarse,'depth_coarse':depth_coarse,'opacity_coarse':weights_coarse, 'rgb_fine':rgb_final, 'depth_fine':depth_final, 'opacity_fine':weights_final}


    def synthesis(self, ws, ray_origins, ray_directions, neural_rendering_resolution=None, update_emas=False, cache_backbone=False, use_cached_backbone=False, **synthesis_kwargs):
        ...
        # return {'rgb_fine':feature_image, 'depth_fine':depth_image, 'opacity_fine':depth_image}
